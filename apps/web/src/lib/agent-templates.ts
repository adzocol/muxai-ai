...
export const AGENT_TEMPLATES: AgentTemplate[] = [
  {
    ...
    form: {
      ...
      cwd: "",
      disallowedTools: "Read,Write,Edit,Bash,Grep,Glob,Agent,mcp__news-analyst__get_crypto_news,mcp__chart-analyst__analyze_chart,mcp__crypto-ohlcv__get_candles,mcp__crypto-ohlcv__get_indicators,mcp__crypto-ohlcv__search_symbols,mcp__crypto-data__get_funding_rate,mcp__crypto-data__get_open_interest,mcp__crypto-data__get_long_short_ratio,mcp__crypto-data__get_top_trader_positions,mcp__crypto-data__get_taker_buy_sell_volume,mcp__events__get_upcoming_events,mcp__events__get_recent_events",
      maxTurnsPerRun: "30",
      customCron: "",
    },
  },
  ...
  },
  {
    ...
    form: {
      ...
      cwd: "",
      disallowedTools: "Read,Write,Edit,Bash,Grep,Glob,Agent,mcp__news-analyst__get_crypto_news,mcp__crypto-data__get_funding_rate,mcp__crypto-data__get_open_interest,mcp__crypto-data__get_long_short_ratio,mcp__crypto-data__get_top_trader_positions,mcp__crypto-data__get_taker_buy_sell_volume,mcp__wallet__wallet_address,mcp__wallet__wallet_fetch,mcp__contractor__ask_contractor,mcp__contractor__list_contractors,mcp__orchestrator__run_team,mcp__orchestrator__ask_reporter,mcp__orchestrator__get_my_decisions,mcp__events__get_upcoming_events,mcp__events__get_recent_events",
      maxTurnsPerRun: "10",
      customCron: "",
    },
  },
